...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Capitel 000 Einleitung
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\input{Kapitel/000/einleitung}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Capitel 001 Was ist Bitcoin
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\input{Kapitel/001/was_ist_bitcoin}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Capitel 002 Wie funktioniert Bitcoin
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\input{Kapitel/002/wie_funktioniert}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Capitel 003 Sicherheit
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%\input{Kapitel/003/sicherheit}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Capitel 004 Oekonomie und Gesetz
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\input{Kapitel/004/oekonomie_und_gesetz}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Capitel 005 Vor und Nachteile
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\input{Kapitel/005/vor_nachteile}
...
\noindent
Die Seminararbeit zum Thema Bitcoin hat uns einen grösseren Einblick in die Welt eines dezentralen Rechnungsnetzwerk eingeführt.
...
\noindent
Wie schon erwähnt wurde, befindet sich Bitcoin immer noch in der Beta-phase, und es wird sehr spannend sein die weitere Entwicklung
des Systems zu beobachten. Vor allem wird es spannend sein zu sehen wie sich das System entwickelt, wenn es für die Miner plötzlich
nicht mehr rentabel wird. Und da Bitcoins eine bestimmte Menge vorprogrammiert hat wird dies einmal der Fall sein.
Wir sind uns sicher dass eine gute Lösung gefunden wird, die die Nutzer auch akzeptieren. Wir vermuten, dass dann die Transaktionsgebühren höher sein werden,
sodass es für die Miner, ohne die das System nicht funktionieren würde, immer noch rentabel ist. Im Moment müssen wir uns keine Sorgen machen,
da es noch genügend Bitcoins an vorrat hat.

\noindent
Die Arbeit hat viel Zeit in Anspruch genommen, doch am Ende hat es sich gelohnt.
Während dieser Arbeit haben wir viel Wissen mitnehmen können, was wir in Zukunft
sicherlich einmal brauchen werden können. Dies ist nun das Ende unserer zweiten Informatik-
Seminar Arbeit, wir hoffen das wir Ihnen einen kleinen Einblick in die Welt des Bitcoins bieten durften.
Vielen Dank an die Dozenten welche uns die Möoglichkeit gegeben haben dieses Thema erarbeiten zu dürfen.
